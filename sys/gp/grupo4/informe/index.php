...
class PDF extends FPDF
{
	...
	function Header()
	{
		...
		$this->Cell(100,10,utf8_decode('GRUPO DE PREDICACIÓN NO. 4'),0,0,'C');
...
// Consulta del mes
$query = "SELECT mes4 FROM $table1 WHERE mes4 != ''";
...
while($month = mysqli_fetch_assoc($plen)) {
	...
	$pdf->Cell(-130,10,$month['mes4'],0,0,'C');
}
...
$pr_pub1 = "SELECT * FROM $table2 WHERE id_pub= 61 AND tipo = 'PR'";
...
$pr_pub2 = "SELECT * FROM $table2 WHERE id_pub= 62 AND tipo = 'PR'";
...
$pr_pub3 = "SELECT * FROM $table2 WHERE id_pub= 63 AND tipo = 'PR'";
...
$pr_pub4 = "SELECT * FROM $table2 WHERE id_pub= 64 AND tipo = 'PR'";
...
$pr_pub5 = "SELECT * FROM $table2 WHERE id_pub= 65 AND tipo = 'PR'";
...
$pr_pub6 = "SELECT * FROM $table2 WHERE id_pub= 66 AND tipo = 'PR'";
...
$pr_pub7 = "SELECT * FROM $table2 WHERE id_pub= 67 AND tipo = 'PR'";
...
$pr_pub8 = "SELECT * FROM $table2 WHERE id_pub= 68 AND tipo = 'PR'";
...
$pr_pub9 = "SELECT * FROM $table2 WHERE id_pub= 69 AND tipo = 'PR'";
...
$pr_pub10 = "SELECT * FROM $table2 WHERE id_pub= 70 AND tipo = 'PR'";
...
$pr_pub11 = "SELECT * FROM $table2 WHERE id_pub= 71 AND tipo = 'PR'";
...
$pr_pub12 = "SELECT * FROM $table2 WHERE id_pub= 72 AND tipo = 'PR'";
...
$pr_pub13 = "SELECT * FROM $table2 WHERE id_pub= 73 AND tipo = 'PR'";
...
$pr_pub14 = "SELECT * FROM $table2 WHERE id_pub= 74 AND tipo = 'PR'";
...
$pr_pub15 = "SELECT * FROM $table2 WHERE id_pub= 75 AND tipo = 'PR'";
...
$pr_pub16 = "SELECT * FROM $table2 WHERE id_pub= 76 AND tipo = 'PR'";
...
$pr_pub17 = "SELECT * FROM $table2 WHERE id_pub= 77 AND tipo = 'PR'";
...
$pr_pub18 = "SELECT * FROM $table2 WHERE id_pub= 78 AND tipo = 'PR'";
...
$pr_pub19 = "SELECT * FROM $table2 WHERE id_pub= 79 AND tipo = 'PR'";
...
$pr_pub20 = "SELECT * FROM $table2 WHERE id_pub= 80 AND tipo = 'PR'";
...
$pa_pub1 = "SELECT * FROM $table2 WHERE id_pub= 61 AND tipo = 'PA'";
...
$pa_pub2 = "SELECT * FROM $table2 WHERE id_pub= 62 AND tipo = 'PA'";
...
$pa_pub3 = "SELECT * FROM $table2 WHERE id_pub= 63 AND tipo = 'PA'";
...
$pa_pub4 = "SELECT * FROM $table2 WHERE id_pub= 64 AND tipo = 'PA'";
...
$pa_pub5 = "SELECT * FROM $table2 WHERE id_pub= 65 AND tipo = 'PA'";
...
$pa_pub6 = "SELECT * FROM $table2 WHERE id_pub= 66 AND tipo = 'PA'";
...
$pa_pub7 = "SELECT * FROM $table2 WHERE id_pub= 67 AND tipo = 'PA'";
...
$pa_pub8 = "SELECT * FROM $table2 WHERE id_pub= 68 AND tipo = 'PA'";
...
$pa_pub9 = "SELECT * FROM $table2 WHERE id_pub= 69 AND tipo = 'PA'";
...
$pa_pub10 = "SELECT * FROM $table2 WHERE id_pub= 70 AND tipo = 'PA'";
...
$pa_pub11 = "SELECT * FROM $table2 WHERE id_pub= 71 AND tipo = 'PA'";
...
$pa_pub12 = "SELECT * FROM $table2 WHERE id_pub= 72 AND tipo = 'PA'";
...
$pa_pub13 = "SELECT * FROM $table2 WHERE id_pub= 73 AND tipo = 'PA'";
...
$pa_pub14 = "SELECT * FROM $table2 WHERE id_pub= 74 AND tipo = 'PA'";
...
$pa_pub15 = "SELECT * FROM $table2 WHERE id_pub= 75 AND tipo = 'PA'";
...
$pa_pub16 = "SELECT * FROM $table2 WHERE id_pub= 76 AND tipo = 'PA'";
...
$pa_pub17 = "SELECT * FROM $table2 WHERE id_pub= 77 AND tipo = 'PA'";
...
$pa_pub18 = "SELECT * FROM $table2 WHERE id_pub= 78 AND tipo = 'PA'";
...
$pa_pub19 = "SELECT * FROM $table2 WHERE id_pub= 79 AND tipo = 'PA'";
...
$pa_pub20 = "SELECT * FROM $table2 WHERE id_pub= 80 AND tipo = 'PA'";
...
$pub_pub1 = "SELECT * FROM $table2 WHERE id_pub= 61 AND tipo = 'PUB'";
...
$pub_pub2 = "SELECT * FROM $table2 WHERE id_pub= 62 AND tipo = 'PUB'";
...
$pub_pub3 = "SELECT * FROM $table2 WHERE id_pub= 63 AND tipo = 'PUB'";
...
$pub_pub4 = "SELECT * FROM $table2 WHERE id_pub= 64 AND tipo = 'PUB'";
...
$pub_pub5 = "SELECT * FROM $table2 WHERE id_pub= 65 AND tipo = 'PUB'";
...
$pub_pub6 = "SELECT * FROM $table2 WHERE id_pub= 66 AND tipo = 'PUB'";
...
$pub_pub7 = "SELECT * FROM $table2 WHERE id_pub= 67 AND tipo = 'PUB'";
...
$pub_pub8 = "SELECT * FROM $table2 WHERE id_pub= 68 AND tipo = 'PUB'";
...
$pub_pub9 = "SELECT * FROM $table2 WHERE id_pub= 69 AND tipo = 'PUB'";
...
$pub_pub10 = "SELECT * FROM $table2 WHERE id_pub= 70 AND tipo = 'PUB'";
...
$pub_pub11 = "SELECT * FROM $table2 WHERE id_pub= 71 AND tipo = 'PUB'";
...
$pub_pub12 = "SELECT * FROM $table2 WHERE id_pub= 72 AND tipo = 'PUB'";
...
$pub_pub13 = "SELECT * FROM $table2 WHERE id_pub= 73 AND tipo = 'PUB'";
...
$pub_pub14 = "SELECT * FROM $table2 WHERE id_pub= 74 AND tipo = 'PUB'";
...
$pub_pub15 = "SELECT * FROM $table2 WHERE id_pub= 75 AND tipo = 'PUB'";
...
$pub_pub16 = "SELECT * FROM $table2 WHERE id_pub= 76 AND tipo = 'PUB'";
...
$pub_pub17 = "SELECT * FROM $table2 WHERE id_pub= 77 AND tipo = 'PUB'";
...
$pub_pub18 = "SELECT * FROM $table2 WHERE id_pub= 78 AND tipo = 'PUB'";
...
$pub_pub19 = "SELECT * FROM $table2 WHERE id_pub= 79 AND tipo = 'PUB'";
...
$pub_pub20 = "SELECT * FROM $table2 WHERE id_pub= 80 AND tipo = 'PUB'";
...
$pdf->Output('I','INFORME DE SERVICIO MENSUAL DEL GRUPO 4.pdf');
