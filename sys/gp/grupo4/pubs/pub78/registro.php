...
<body>
	...
	<div class="container">
		...
		<form class="form-inline" id="informe" method="POST" action="#"><br>
			...
			<h4 class="nombre_informe"><center><strong><?php informe_pub78(); ?></strong></center></h4>
...
if (isset($_POST['guardar'])) {
	...
	$insercion = "UPDATE $table2 SET publicaciones = '$publicaciones', videos = '$videos', horas = '$horas', revisitas = '$revisitas', cursos = '$cursos', comentarios = '$comentarios', tipo = '$tipo' WHERE id_pub = 78";
	$ejecucion = mysqli_query($cn, $insercion);

	echo "<script>alert('INFORME GUARDADO CORRECTAMENTE')</script>";
	echo '<meta HTTP-EQUIV="REFRESH" CONTENT="0;URL=/ig/sys/gp/grupo4/pubs/pub78/">';
