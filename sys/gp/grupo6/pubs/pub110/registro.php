...
<body>
	...
	<div class="container">
		...
		<div class="alert alert-danger">
			<strong><center>Verifica que los datos sean correctos<button type="button" class="close" data-dismiss="alert">&times;</button></center>
			</strong>
		</div>
		...
		<form class="form-inline" id="informe" method="POST" action="#"><br>
			...
			<h4 class="nombre_informe"><center><strong><?php informe_pub110(); ?></strong></center></h4>
...
if (isset($_POST['guardar'])) {
	...
	$insercion = "UPDATE $table2 SET publicaciones = '$publicaciones', videos = '$videos', horas = '$horas', revisitas = '$revisitas', cursos = '$cursos', comentarios = '$comentarios', tipo = '$tipo' WHERE id_pub = 110";
	$ejecucion = mysqli_query($cn, $insercion);

	echo "<script>alert('INFORME GUARDADO CORRECTAMENTE')</script>";
	echo '<meta HTTP-EQUIV="REFRESH" CONTENT="0;URL=/ig/sys/gp/grupo6/pubs/pub110/">';
