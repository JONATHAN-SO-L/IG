...
$pub4 = "SELECT nombre, horas, tipo FROM $table2 WHERE id_pub=4";
$pub5 = "SELECT nombre, horas, tipo FROM $table2 WHERE id_pub=5";
$pub6 = "SELECT nombre, horas, tipo FROM $table2 WHERE id_pub=6";
$pub7 = "SELECT nombre, horas, tipo FROM $table2 WHERE id_pub=7";
$pub8 = "SELECT nombre, horas, tipo FROM $table2 WHERE id_pub=8";
$pub9 = "SELECT nombre, horas, tipo FROM $table2 WHERE id_pub=9";
$pub10 = "SELECT nombre, horas, tipo FROM $table2 WHERE id_pub=10";
$pub11 = "SELECT nombre, horas, tipo FROM $table2 WHERE id_pub=11";
$pub12 = "SELECT nombre, horas, tipo FROM $table2 WHERE id_pub=12";
$pub13 = "SELECT nombre, horas, tipo FROM $table2 WHERE id_pub=13";
$pub14 = "SELECT nombre, horas, tipo FROM $table2 WHERE id_pub=14";
$pub15 = "SELECT nombre, horas, tipo FROM $table2 WHERE id_pub=15";
$pub16 = "SELECT nombre, horas, tipo FROM $table2 WHERE id_pub=16";
$pub17 = "SELECT nombre, horas, tipo FROM $table2 WHERE id_pub=17";
$pub18 = "SELECT nombre, horas, tipo FROM $table2 WHERE id_pub=18";
