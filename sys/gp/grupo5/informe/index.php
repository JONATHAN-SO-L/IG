...
class PDF extends FPDF
{
	...
	function Header()
	{
		...
		$this->Cell(100,10,utf8_decode('GRUPO DE PREDICACIÓN NO. 5'),0,0,'C');
...
// Consulta del mes
$query = "SELECT mes5 FROM $table1 WHERE mes5 != ''";
...
while($month = mysqli_fetch_assoc($plen)) {
	...
	$pdf->Cell(-130,10,$month['mes5'],0,0,'C');
}
...
$pr_pub1 = "SELECT * FROM $table2 WHERE id_pub= 81 AND tipo = 'PR'";
...
$pr_pub2 = "SELECT * FROM $table2 WHERE id_pub= 82 AND tipo = 'PR'";
...
$pr_pub3 = "SELECT * FROM $table2 WHERE id_pub= 83 AND tipo = 'PR'";
...
$pr_pub4 = "SELECT * FROM $table2 WHERE id_pub= 84 AND tipo = 'PR'";
...
$pr_pub5 = "SELECT * FROM $table2 WHERE id_pub= 85 AND tipo = 'PR'";
...
$pr_pub6 = "SELECT * FROM $table2 WHERE id_pub= 86 AND tipo = 'PR'";
...
$pr_pub7 = "SELECT * FROM $table2 WHERE id_pub= 87 AND tipo = 'PR'";
...
$pr_pub8 = "SELECT * FROM $table2 WHERE id_pub= 88 AND tipo = 'PR'";
...
$pr_pub9 = "SELECT * FROM $table2 WHERE id_pub= 89 AND tipo = 'PR'";
...
$pr_pub10 = "SELECT * FROM $table2 WHERE id_pub= 90 AND tipo = 'PR'";
...
$pr_pub11 = "SELECT * FROM $table2 WHERE id_pub= 91 AND tipo = 'PR'";
...
$pr_pub12 = "SELECT * FROM $table2 WHERE id_pub= 92 AND tipo = 'PR'";
...
$pr_pub13 = "SELECT * FROM $table2 WHERE id_pub= 93 AND tipo = 'PR'";
...
$pr_pub14 = "SELECT * FROM $table2 WHERE id_pub= 94 AND tipo = 'PR'";
...
$pr_pub15 = "SELECT * FROM $table2 WHERE id_pub= 95 AND tipo = 'PR'";
...
$pr_pub16 = "SELECT * FROM $table2 WHERE id_pub= 96 AND tipo = 'PR'";
...
$pr_pub17 = "SELECT * FROM $table2 WHERE id_pub= 97 AND tipo = 'PR'";
...
$pr_pub18 = "SELECT * FROM $table2 WHERE id_pub= 98 AND tipo = 'PR'";
...
$pr_pub19 = "SELECT * FROM $table2 WHERE id_pub= 99 AND tipo = 'PR'";
...
$pr_pub20 = "SELECT * FROM $table2 WHERE id_pub= 100 AND tipo = 'PR'";
...
$pa_pub1 = "SELECT * FROM $table2 WHERE id_pub= 81 AND tipo = 'PA'";
...
$pa_pub2 = "SELECT * FROM $table2 WHERE id_pub= 82 AND tipo = 'PA'";
...
$pa_pub3 = "SELECT * FROM $table2 WHERE id_pub= 83 AND tipo = 'PA'";
...
$pa_pub4 = "SELECT * FROM $table2 WHERE id_pub= 84 AND tipo = 'PA'";
...
$pa_pub5 = "SELECT * FROM $table2 WHERE id_pub= 85 AND tipo = 'PA'";
...
$pa_pub6 = "SELECT * FROM $table2 WHERE id_pub= 86 AND tipo = 'PA'";
...
$pa_pub7 = "SELECT * FROM $table2 WHERE id_pub= 87 AND tipo = 'PA'";
...
$pa_pub8 = "SELECT * FROM $table2 WHERE id_pub= 88 AND tipo = 'PA'";
...
$pa_pub9 = "SELECT * FROM $table2 WHERE id_pub= 89 AND tipo = 'PA'";
...
$pa_pub10 = "SELECT * FROM $table2 WHERE id_pub= 90 AND tipo = 'PA'";
...
$pa_pub11 = "SELECT * FROM $table2 WHERE id_pub= 91 AND tipo = 'PA'";
...
$pa_pub12 = "SELECT * FROM $table2 WHERE id_pub= 92 AND tipo = 'PA'";
...
$pa_pub13 = "SELECT * FROM $table2 WHERE id_pub= 93 AND tipo = 'PA'";
...
$pa_pub14 = "SELECT * FROM $table2 WHERE id_pub= 94 AND tipo = 'PA'";
...
$pa_pub15 = "SELECT * FROM $table2 WHERE id_pub= 95 AND tipo = 'PA'";
...
$pa_pub16 = "SELECT * FROM $table2 WHERE id_pub= 96 AND tipo = 'PA'";
...
$pa_pub17 = "SELECT * FROM $table2 WHERE id_pub= 97 AND tipo = 'PA'";
...
$pa_pub18 = "SELECT * FROM $table2 WHERE id_pub= 98 AND tipo = 'PA'";
...
$pa_pub19 = "SELECT * FROM $table2 WHERE id_pub= 99 AND tipo = 'PA'";
...
$pa_pub20 = "SELECT * FROM $table2 WHERE id_pub= 100 AND tipo = 'PA'";
...
$pub_pub1 = "SELECT * FROM $table2 WHERE id_pub= 81 AND tipo = 'PUB'";
...
$pub_pub2 = "SELECT * FROM $table2 WHERE id_pub= 82 AND tipo = 'PUB'";
...
$pub_pub3 = "SELECT * FROM $table2 WHERE id_pub= 83 AND tipo = 'PUB'";
...
$pub_pub4 = "SELECT * FROM $table2 WHERE id_pub= 84 AND tipo = 'PUB'";
...
$pub_pub5 = "SELECT * FROM $table2 WHERE id_pub= 85 AND tipo = 'PUB'";
...
$pub_pub6 = "SELECT * FROM $table2 WHERE id_pub= 86 AND tipo = 'PUB'";
...
$pub_pub7 = "SELECT * FROM $table2 WHERE id_pub= 87 AND tipo = 'PUB'";
...
$pub_pub8 = "SELECT * FROM $table2 WHERE id_pub= 88 AND tipo = 'PUB'";
...
$pub_pub9 = "SELECT * FROM $table2 WHERE id_pub= 89 AND tipo = 'PUB'";
...
$pub_pub10 = "SELECT * FROM $table2 WHERE id_pub= 90 AND tipo = 'PUB'";
...
$pub_pub11 = "SELECT * FROM $table2 WHERE id_pub= 91 AND tipo = 'PUB'";
...
$pub_pub12 = "SELECT * FROM $table2 WHERE id_pub= 92 AND tipo = 'PUB'";
...
$pub_pub13 = "SELECT * FROM $table2 WHERE id_pub= 93 AND tipo = 'PUB'";
...
$pub_pub14 = "SELECT * FROM $table2 WHERE id_pub= 94 AND tipo = 'PUB'";
...
$pub_pub15 = "SELECT * FROM $table2 WHERE id_pub= 95 AND tipo = 'PUB'";
...
$pub_pub16 = "SELECT * FROM $table2 WHERE id_pub= 96 AND tipo = 'PUB'";
...
$pub_pub17 = "SELECT * FROM $table2 WHERE id_pub= 97 AND tipo = 'PUB'";
...
$pub_pub18 = "SELECT * FROM $table2 WHERE id_pub= 98 AND tipo = 'PUB'";
...
$pub_pub19 = "SELECT * FROM $table2 WHERE id_pub= 99 AND tipo = 'PUB'";
...
$pub_pub20 = "SELECT * FROM $table2 WHERE id_pub= 100 AND tipo = 'PUB'";
...
$pdf->Output('I','INFORME DE SERVICIO MENSUAL DEL GRUPO 5.pdf');
