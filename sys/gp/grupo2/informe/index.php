...
class PDF extends FPDF
{
	...
	function Header()
	{
		...
		$this->Cell(100,10,utf8_decode('GRUPO DE PREDICACIÓN NO. 2'),0,0,'C');
...
// Consulta del mes
$query = "SELECT mes2 FROM $table1 WHERE mes2 != ''";
...
while($month = mysqli_fetch_assoc($plen)) {
	...
	$pdf->Cell(-130,10,$month['mes2'],0,0,'C');
}
...
$pr_pub1 = "SELECT * FROM $table2 WHERE id_pub= 21 AND tipo = 'PR'";
...
$pr_pub2 = "SELECT * FROM $table2 WHERE id_pub= 22 AND tipo = 'PR'";
...
$pr_pub3 = "SELECT * FROM $table2 WHERE id_pub= 23 AND tipo = 'PR'";
...
$pr_pub4 = "SELECT * FROM $table2 WHERE id_pub= 24 AND tipo = 'PR'";
...
$pr_pub5 = "SELECT * FROM $table2 WHERE id_pub= 25 AND tipo = 'PR'";
...
$pr_pub6 = "SELECT * FROM $table2 WHERE id_pub= 26 AND tipo = 'PR'";
...
$pr_pub7 = "SELECT * FROM $table2 WHERE id_pub= 27 AND tipo = 'PR'";
...
$pr_pub8 = "SELECT * FROM $table2 WHERE id_pub= 28 AND tipo = 'PR'";
...
$pr_pub9 = "SELECT * FROM $table2 WHERE id_pub= 29 AND tipo = 'PR'";
...
$pr_pub10 = "SELECT * FROM $table2 WHERE id_pub= 30 AND tipo = 'PR'";
...
$pr_pub11 = "SELECT * FROM $table2 WHERE id_pub= 31 AND tipo = 'PR'";
...
$pr_pub12 = "SELECT * FROM $table2 WHERE id_pub= 32 AND tipo = 'PR'";
...
$pr_pub13 = "SELECT * FROM $table2 WHERE id_pub= 33 AND tipo = 'PR'";
...
$pr_pub14 = "SELECT * FROM $table2 WHERE id_pub= 34 AND tipo = 'PR'";
...
$pr_pub15 = "SELECT * FROM $table2 WHERE id_pub= 35 AND tipo = 'PR'";
...
$pr_pub16 = "SELECT * FROM $table2 WHERE id_pub= 36 AND tipo = 'PR'";
...
$pr_pub17 = "SELECT * FROM $table2 WHERE id_pub= 37 AND tipo = 'PR'";
...
$pr_pub18 = "SELECT * FROM $table2 WHERE id_pub= 38 AND tipo = 'PR'";
...
$pr_pub19 = "SELECT * FROM $table2 WHERE id_pub= 39 AND tipo = 'PR'";
...
$pr_pub20 = "SELECT * FROM $table2 WHERE id_pub= 40 AND tipo = 'PR'";
...
$pa_pub1 = "SELECT * FROM $table2 WHERE id_pub= 21 AND tipo = 'PA'";
...
$pa_pub2 = "SELECT * FROM $table2 WHERE id_pub= 22 AND tipo = 'PA'";
...
$pa_pub3 = "SELECT * FROM $table2 WHERE id_pub= 23 AND tipo = 'PA'";
...
$pa_pub4 = "SELECT * FROM $table2 WHERE id_pub= 24 AND tipo = 'PA'";
...
$pa_pub5 = "SELECT * FROM $table2 WHERE id_pub= 25 AND tipo = 'PA'";
...
$pa_pub6 = "SELECT * FROM $table2 WHERE id_pub= 26 AND tipo = 'PA'";
...
$pa_pub7 = "SELECT * FROM $table2 WHERE id_pub= 27 AND tipo = 'PA'";
...
$pa_pub8 = "SELECT * FROM $table2 WHERE id_pub= 28 AND tipo = 'PA'";
...
$pa_pub9 = "SELECT * FROM $table2 WHERE id_pub= 29 AND tipo = 'PA'";
...
$pa_pub10 = "SELECT * FROM $table2 WHERE id_pub= 30 AND tipo = 'PA'";
...
$pa_pub11 = "SELECT * FROM $table2 WHERE id_pub= 31 AND tipo = 'PA'";
...
$pa_pub12 = "SELECT * FROM $table2 WHERE id_pub= 32 AND tipo = 'PA'";
...
$pa_pub13 = "SELECT * FROM $table2 WHERE id_pub= 33 AND tipo = 'PA'";
...
$pa_pub14 = "SELECT * FROM $table2 WHERE id_pub= 34 AND tipo = 'PA'";
...
$pa_pub15 = "SELECT * FROM $table2 WHERE id_pub= 35 AND tipo = 'PA'";
...
$pa_pub16 = "SELECT * FROM $table2 WHERE id_pub= 36 AND tipo = 'PA'";
...
$pa_pub17 = "SELECT * FROM $table2 WHERE id_pub= 37 AND tipo = 'PA'";
...
$pa_pub18 = "SELECT * FROM $table2 WHERE id_pub= 38 AND tipo = 'PA'";
...
$pa_pub19 = "SELECT * FROM $table2 WHERE id_pub= 39 AND tipo = 'PA'";
...
$pa_pub20 = "SELECT * FROM $table2 WHERE id_pub= 40 AND tipo = 'PA'";
...
$pub_pub1 = "SELECT * FROM $table2 WHERE id_pub= 21 AND tipo = 'PUB'";
...
$pub_pub2 = "SELECT * FROM $table2 WHERE id_pub= 22 AND tipo = 'PUB'";
...
$pub_pub3 = "SELECT * FROM $table2 WHERE id_pub= 23 AND tipo = 'PUB'";
...
$pub_pub4 = "SELECT * FROM $table2 WHERE id_pub= 24 AND tipo = 'PUB'";
...
$pub_pub5 = "SELECT * FROM $table2 WHERE id_pub= 25 AND tipo = 'PUB'";
...
$pub_pub6 = "SELECT * FROM $table2 WHERE id_pub= 26 AND tipo = 'PUB'";
...
$pub_pub7 = "SELECT * FROM $table2 WHERE id_pub= 27 AND tipo = 'PUB'";
...
$pub_pub8 = "SELECT * FROM $table2 WHERE id_pub= 28 AND tipo = 'PUB'";
...
$pub_pub9 = "SELECT * FROM $table2 WHERE id_pub= 29 AND tipo = 'PUB'";
...
$pub_pub10 = "SELECT * FROM $table2 WHERE id_pub= 30 AND tipo = 'PUB'";
...
$pub_pub11 = "SELECT * FROM $table2 WHERE id_pub= 31 AND tipo = 'PUB'";
...
$pub_pub12 = "SELECT * FROM $table2 WHERE id_pub= 32 AND tipo = 'PUB'";
...
$pub_pub13 = "SELECT * FROM $table2 WHERE id_pub= 33 AND tipo = 'PUB'";
...
$pub_pub14 = "SELECT * FROM $table2 WHERE id_pub= 34 AND tipo = 'PUB'";
...
$pub_pub15 = "SELECT * FROM $table2 WHERE id_pub= 35 AND tipo = 'PUB'";
...
$pub_pub16 = "SELECT * FROM $table2 WHERE id_pub= 36 AND tipo = 'PUB'";
...
$pub_pub17 = "SELECT * FROM $table2 WHERE id_pub= 37 AND tipo = 'PUB'";
...
$pub_pub18 = "SELECT * FROM $table2 WHERE id_pub= 38 AND tipo = 'PUB'";
...
$pub_pub19 = "SELECT * FROM $table2 WHERE id_pub= 39 AND tipo = 'PUB'";
...
$pub_pub20 = "SELECT * FROM $table2 WHERE id_pub= 40 AND tipo = 'PUB'";
...
$pdf->Output('I','INFORME DE SERVICIO MENSUAL DEL GRUPO 2.pdf');
