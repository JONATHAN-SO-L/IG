...
class PDF extends FPDF
{
	...
	function Header()
	{
		...
		$this->Cell(100,10,utf8_decode('GRUPO DE PREDICACIÓN NO. 3'),0,0,'C');
...
// Consulta del mes
$query = "SELECT mes3 FROM $table1 WHERE mes3 != ''";
...
while($month = mysqli_fetch_assoc($plen)) {
	...
	$pdf->Cell(-130,10,$month['mes3'],0,0,'C');
}
...
$pr_pub1 = "SELECT * FROM $table2 WHERE id_pub= 41 AND tipo = 'PR'";
...
$pr_pub2 = "SELECT * FROM $table2 WHERE id_pub= 42 AND tipo = 'PR'";
...
$pr_pub3 = "SELECT * FROM $table2 WHERE id_pub= 43 AND tipo = 'PR'";
...
$pr_pub4 = "SELECT * FROM $table2 WHERE id_pub= 44 AND tipo = 'PR'";
...
$pr_pub5 = "SELECT * FROM $table2 WHERE id_pub= 45 AND tipo = 'PR'";
...
$pr_pub6 = "SELECT * FROM $table2 WHERE id_pub= 46 AND tipo = 'PR'";
...
$pr_pub7 = "SELECT * FROM $table2 WHERE id_pub= 47 AND tipo = 'PR'";
...
$pr_pub8 = "SELECT * FROM $table2 WHERE id_pub= 48 AND tipo = 'PR'";
...
$pr_pub9 = "SELECT * FROM $table2 WHERE id_pub= 49 AND tipo = 'PR'";
...
$pr_pub10 = "SELECT * FROM $table2 WHERE id_pub= 50 AND tipo = 'PR'";
...
$pr_pub11 = "SELECT * FROM $table2 WHERE id_pub= 51 AND tipo = 'PR'";
...
$pr_pub12 = "SELECT * FROM $table2 WHERE id_pub= 52 AND tipo = 'PR'";
...
$pr_pub13 = "SELECT * FROM $table2 WHERE id_pub= 53 AND tipo = 'PR'";
...
$pr_pub14 = "SELECT * FROM $table2 WHERE id_pub= 54 AND tipo = 'PR'";
...
$pr_pub15 = "SELECT * FROM $table2 WHERE id_pub= 55 AND tipo = 'PR'";
...
$pr_pub16 = "SELECT * FROM $table2 WHERE id_pub= 56 AND tipo = 'PR'";
...
$pr_pub17 = "SELECT * FROM $table2 WHERE id_pub= 57 AND tipo = 'PR'";
...
$pr_pub18 = "SELECT * FROM $table2 WHERE id_pub= 58 AND tipo = 'PR'";
...
$pr_pub19 = "SELECT * FROM $table2 WHERE id_pub= 59 AND tipo = 'PR'";
...
$pr_pub20 = "SELECT * FROM $table2 WHERE id_pub= 60 AND tipo = 'PR'";
...
$pa_pub1 = "SELECT * FROM $table2 WHERE id_pub= 41 AND tipo = 'PA'";
...
$pa_pub2 = "SELECT * FROM $table2 WHERE id_pub= 42 AND tipo = 'PA'";
...
$pa_pub3 = "SELECT * FROM $table2 WHERE id_pub= 43 AND tipo = 'PA'";
...
$pa_pub4 = "SELECT * FROM $table2 WHERE id_pub= 44 AND tipo = 'PA'";
...
$pa_pub5 = "SELECT * FROM $table2 WHERE id_pub= 45 AND tipo = 'PA'";
...
$pa_pub6 = "SELECT * FROM $table2 WHERE id_pub= 46 AND tipo = 'PA'";
...
$pa_pub7 = "SELECT * FROM $table2 WHERE id_pub= 47 AND tipo = 'PA'";
...
$pa_pub8 = "SELECT * FROM $table2 WHERE id_pub= 48 AND tipo = 'PA'";
...
$pa_pub9 = "SELECT * FROM $table2 WHERE id_pub= 49 AND tipo = 'PA'";
...
$pa_pub10 = "SELECT * FROM $table2 WHERE id_pub= 50 AND tipo = 'PA'";
...
$pa_pub11 = "SELECT * FROM $table2 WHERE id_pub= 51 AND tipo = 'PA'";
...
$pa_pub12 = "SELECT * FROM $table2 WHERE id_pub= 52 AND tipo = 'PA'";
...
$pa_pub13 = "SELECT * FROM $table2 WHERE id_pub= 53 AND tipo = 'PA'";
...
$pa_pub14 = "SELECT * FROM $table2 WHERE id_pub= 54 AND tipo = 'PA'";
...
$pa_pub15 = "SELECT * FROM $table2 WHERE id_pub= 55 AND tipo = 'PA'";
...
$pa_pub16 = "SELECT * FROM $table2 WHERE id_pub= 56 AND tipo = 'PA'";
...
$pa_pub17 = "SELECT * FROM $table2 WHERE id_pub= 57 AND tipo = 'PA'";
...
$pa_pub18 = "SELECT * FROM $table2 WHERE id_pub= 58 AND tipo = 'PA'";
...
$pa_pub19 = "SELECT * FROM $table2 WHERE id_pub= 59 AND tipo = 'PA'";
...
$pa_pub20 = "SELECT * FROM $table2 WHERE id_pub= 60 AND tipo = 'PA'";
...
$pub_pub1 = "SELECT * FROM $table2 WHERE id_pub= 41 AND tipo = 'PUB'";
...
$pub_pub2 = "SELECT * FROM $table2 WHERE id_pub= 42 AND tipo = 'PUB'";
...
$pub_pub3 = "SELECT * FROM $table2 WHERE id_pub= 43 AND tipo = 'PUB'";
...
$pub_pub4 = "SELECT * FROM $table2 WHERE id_pub= 44 AND tipo = 'PUB'";
...
$pub_pub5 = "SELECT * FROM $table2 WHERE id_pub= 45 AND tipo = 'PUB'";
...
$pub_pub6 = "SELECT * FROM $table2 WHERE id_pub= 46 AND tipo = 'PUB'";
...
$pub_pub7 = "SELECT * FROM $table2 WHERE id_pub= 47 AND tipo = 'PUB'";
...
$pub_pub8 = "SELECT * FROM $table2 WHERE id_pub= 48 AND tipo = 'PUB'";
...
$pub_pub9 = "SELECT * FROM $table2 WHERE id_pub= 49 AND tipo = 'PUB'";
...
$pub_pub10 = "SELECT * FROM $table2 WHERE id_pub= 50 AND tipo = 'PUB'";
...
$pub_pub11 = "SELECT * FROM $table2 WHERE id_pub= 51 AND tipo = 'PUB'";
...
$pub_pub12 = "SELECT * FROM $table2 WHERE id_pub= 52 AND tipo = 'PUB'";
...
$pub_pub13 = "SELECT * FROM $table2 WHERE id_pub= 53 AND tipo = 'PUB'";
...
$pub_pub14 = "SELECT * FROM $table2 WHERE id_pub= 54 AND tipo = 'PUB'";
...
$pub_pub15 = "SELECT * FROM $table2 WHERE id_pub= 55 AND tipo = 'PUB'";
...
$pub_pub16 = "SELECT * FROM $table2 WHERE id_pub= 56 AND tipo = 'PUB'";
...
$pub_pub17 = "SELECT * FROM $table2 WHERE id_pub= 57 AND tipo = 'PUB'";
...
$pub_pub18 = "SELECT * FROM $table2 WHERE id_pub= 58 AND tipo = 'PUB'";
...
$pub_pub19 = "SELECT * FROM $table2 WHERE id_pub= 59 AND tipo = 'PUB'";
...
$pub_pub20 = "SELECT * FROM $table2 WHERE id_pub= 60 AND tipo = 'PUB'";
...
$pdf->Output('I','INFORME DE SERVICIO MENSUAL DEL GRUPO 3.pdf');
